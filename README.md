...
| `/haven status` | `haven.use` | Shows the HavenCore version plus hook, economy, database pool, async executor, storage, codex service, and OP-toggle health. VaultUnlocked status distinguishes plugin detection from economy provider availability. |
