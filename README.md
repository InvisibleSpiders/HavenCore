...
| --- | --- | --- |
| `/haven` | `haven.use` | Shows the same status output as `/haven status`. |
| `/haven status` | `haven.use` | Shows the HavenCore version and the loaded/unavailable state of registered hooks. |
...
| --- | --- | --- |
| `haven.use` | `op` | Allows access to `/haven`, `/haven status`, and `/haven version`. |
